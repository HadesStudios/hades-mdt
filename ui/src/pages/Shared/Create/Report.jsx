...
export default (props) => {
	...
	const initialState = {
		...
		"<p>====================</p>" +
		"<p><b>Screening</b></p>" +
		"<p>Step 1 - Updated Mugshot - <span style='color: red'>NO</span> / <span style='color: green'>YES</span></p>" +
		"<p>Step 2 - Searched - <span style='color: red'>NO</span> / <span style='color: green'>YES</span></p>" +
		"<p>Step 3 - Items Confiscated - <span style='color: red'>NO</span> / <span style='color: green'>YES</span></p>" +
		"<p>Step 4 - Alcohol Test - <span style='color: green'>NEGATIVE</span> / <span style='color: red'>POSITIVE</span></p>" +
		"<p>Step 5 - EMS Drug Test - <span style='color: green'>NEGATIVE</span> / <span style='color: red'>POSITIVE</span></p>" +
		"<p>Step 6 - GSR Results - <span style='color: green'>NEGATIVE</span> / <span style='color: red'>POSITIVE</span></p>" +
		"<p>Step 7 - Felonies - <span style='color: green'>NO</span> / <span style='color: red'>YES</span></p>" +
		"<p>Step 8 - Active Warrant - <span style='color: green'>NO</span> / <span style='color: red'>YES</span></p>" +
		"<p>Step 9 - Weapons License - <span style='color: red'>NO</span> / <span style='color: green'>YES</span></p>" +
		"<p>====================</p>" +
		"<p><b>Charges</b></p>" +
		"<p>Charges</p>" +
		"<p>====================</p>" +
		"<p><b>Report</b></p>" +
		"<p>Leave blank if Guilty or No-Contest Pleas</p>" +
		"<p>====================</p>" +
		"<p><b>Witness Report</b></p>" +
		"<p>Witness 1 - This is how your report should look.</p>" +
		"<p>Witness 2 - Delete these examples.</p>" +
		<></>,
		tagInput: '',
		tags: Array(),
		primariesInput: '',
